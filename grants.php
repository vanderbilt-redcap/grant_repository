...
echo "<form style='margin-bottom: 0px;' method='get'>";
echo "<label for='searchTerms'>Search Abstracts:</label> <input type='text' id='searchTerms' name='searchTerms' value='' /> <button>Go!</button><br/>(Double quotes are permitted to search for a phrase.)";
echo "</form>";
echo "</div>";
